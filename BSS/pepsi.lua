...
local versioN = "1.32" -- https://api.roblox.com/assets/4384103988/versions
spawn(function()local coins = workspace.Collectibles local big = Vector3.one * 100 coins.ChildAdded:Connect(function(c)c.AncestryChanged:Connect(function(_, p)for _ = 0, 3, 0.1 do wait(0.1)if p == coins then return end end c.Size = big c.Transparency = 1 c = (c and c:Destroy() and nil) or nil end)end)end)
Pepsi, dbg = Pepsi, dbg
